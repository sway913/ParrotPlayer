...
import com.lijian.app.player.listener.OnVolumeDBListener;
...
public class ParrotPlayer {
    ...
    private OnVolumeDBListener mOnVolumeDBListener;
    ...
    public OnVolumeDBListener getOnVolumeDBListener() {
        return mOnVolumeDBListener;
    }

    public void setmOnVolumeDBListener(OnVolumeDBListener onVolumeDBListener) {
        this.mOnVolumeDBListener = onVolumeDBListener;
    }
    ...
    private void onCallVolumeDB(int db) {
        if (mOnVolumeDBListener != null) {
            mOnVolumeDBListener.onDBValue(db);
        }
    }
